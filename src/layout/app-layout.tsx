...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'restaurant-manager', 'delivery-driver', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Route', path: '/routes', entity: 'route', service: AccessServiceEnum.PROJECT, icon: FiMap },
