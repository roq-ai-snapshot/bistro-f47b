...
function OrderCreatePage() {
  ...
  const formik = useFormik<OrderInterface>({
    initialValues: {
      status: '',
      restaurant_manager_id: (router.query.restaurant_manager_id as string) ?? null,
      delivery_driver_id: (router.query.delivery_driver_id as string) ?? null,
      customer_service_rep_id: (router.query.customer_service_rep_id as string) ?? null,
    },
